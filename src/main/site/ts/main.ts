...
let sun = document.getElementById("sun") as HTMLSelectElement
let moon = document.getElementById("moon") as HTMLSelectElement
let rising = document.getElementById("rising") as HTMLSelectElement
...
document.addEventListener("keyup", async(e : KeyboardEvent) => {
  if (e.key == "r") {
    await updateValues("Taurus", "Taurus", "Taurus")
    postAndUpdate()
  }
})
